...
@router.post("/wallet/{user_id}/add-money", response_model=TransactionBase)
...
@router.post("/wallet/{user_id}/withdraw", response_model=TransactionBase)
...
@router.get("/transactions/{user_id}?page={page}&limit={limit}")
...
@router.post("/transfer", response_model=TransactionBase)
